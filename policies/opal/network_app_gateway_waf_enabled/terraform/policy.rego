...
package policies.tf_network_app_gateway_waf_enabled
...
app_gws = lacework.resources("azurerm_application_gateway")
...
policy[j] {
  ...
  j = lacework.allow_resource(app_gw)
} {
  app_gw = app_gws[id]
  not valid_app_gws[id]
  j = lacework.deny_resource(app_gw)
}
