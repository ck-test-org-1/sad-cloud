...
import data.tests.policies.tf.aws.security_group.inputs.ingress_anywhere_infra_json
import data.tests.policies.tf.aws.security_group.inputs.invalid_ingress_anywhere_infra_json
...
test_invalid_no_ingress_except_80_443 {
  resources = invalid_ingress_anywhere_infra_json.mock_resources
