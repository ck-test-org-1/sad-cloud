...
package tests.policies.tf.aws.security_group.inputs.invalid_ingress_anywhere_ssh_infra_tf
...
mock_config := {
  ...
  "resources": {
    "aws_security_group.invalid_sg_1": {
      "_filepath": "tests/policies/tf/aws/security_group/inputs/ingress_anywhere_ssh_infra.tf",
      "_provider": "aws",
