...
import data.tests.policies.arm.network.inputs.security_group_no_inbound_3389_infra_json as infra
import data.tests.policies.arm.network.inputs.invalid_security_group_no_inbound_3389_infra_json as invalid_infra
