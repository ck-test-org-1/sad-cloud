...
import data.tests.policies.arm.authorization.inputs.custom_owner_role_infra_json as infra
import data.tests.policies.arm.authorization.inputs.invalid_custom_owner_role_infra_json as invalid_infra
...
test_custom_owner_role {
	deny with input as invalid_infra.mock_resources["Microsoft.Authorization/roleDefinitions/invalidTopLevel"]
	deny with input as invalid_infra.mock_resources["Microsoft.Authorization/roleDefinitions/invalidActionsArr"]
	deny with input as invalid_infra.mock_resources["Microsoft.Authorization/roleDefinitions/invalidHardcodedId"]
	deny with input as invalid_infra.mock_resources["Microsoft.Authorization/roleDefinitions/invalidConcat"]
	deny with input as invalid_infra.mock_resources["Microsoft.Authorization/roleDefinitions/invalidSubscriptionId"]
